...
DUPLICATE_DIR = os.path.abspath(PARENT_DIR + '\\' + 'duplicates')
PDB_DIR = os.path.abspath(PARENT_DIR + '\\' + 'download_pdb')
...
for frag in range(3, 42):
    ...
    for index, row in original_fragment.iterrows():
        ...
        structure_1 = parser_1.get_structure("test1", PDB_DIR + '\\' + file_name_1 + '.pdb')
        structure_2 = parser_2.get_structure("test2", PDB_DIR + '\\' + file_name_2 + '.pdb')
