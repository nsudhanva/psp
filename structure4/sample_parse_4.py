...
for i in range(0, len(auth_temp_atom_id_list)):
    ...
    temp_auth_x = [item for sublist in temp_cartn_x_list[i:i + 3] for item in sublist] 
    temp_auth_y = [item for sublist in temp_cartn_y_list[i:i + 3] for item in sublist] 
    temp_auth_z = [item for sublist in temp_cartn_z_list[i:i + 3] for item in sublist] 
